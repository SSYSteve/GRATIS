...
def train_val_pipeline(MODEL_NAME, dataset, params, net_params, dirs, args):
        ...
        with tqdm(range(params['epochs'])) as t:
            for epoch in t:
                ...
                if MODEL_NAME in ['RingGNN', '3WLGNN']: # since different batch training function for dense GNNs
                    epoch_train_loss, epoch_train_acc, optimizer = train_epoch(model, optimizer, device, train_loader, epoch, params['batch_size'], args)
    ...
    _, test_acc = evaluate_network(model, device, test_loader, epoch, args)
    _, train_acc = evaluate_network(model, device, train_loader, epoch, args)
...
def main():    
    ...
    if args.dataset == 'MNIST':
        net_params['node_num'] = 80
    elif args.dataset == 'CIFAR10':
        net_params['node_num'] = 155
    ###########################################################
