...
def FER2013_infolist(list1,list2):
    infostr = {'neutral: {}/{} {:.2f} | angry: {}/{} {:.2f} | disgust: {}/{} {:.2f} | fear: {}/{} {:.2f} | happy: {}/{} {:.2f} |  sad: {}/{} {:.2f} | surprise: {}/{} {:.2f} |'.format(
        list1[0], list2[0], 100.*(list1[0]/list2[0]), list1[1], list2[1], 100.*(list1[1]/list2[1]), list1[2], list2[2], 100.*(list1[2]/list2[2]), list1[3], list2[3], 100.*(list1[3]/list2[3]), list1[4], list2[4], 100.*(list1[4]/list2[4]), list1[5], list2[5], 100.*(list1[5]/list2[5]), list1[6], list2[6], 100.*(list1[6]/list2[6]))}
    return infostr
...
class image_train(object):
    def __init__(self, img_size=48, crop_size=224):
...
def WeightedCrossEntropy(output,target):
    device = torch.device('cuda:0')
    #nSamples = [5572, 4462, 492, 4593, 8110, 5483, 3586]
    nSamples = [1572, 462, 492, 593, 9110, 483, 8586]
